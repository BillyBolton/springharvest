 ...
 */
public interface IBaseCrudController<D extends BaseDTO<K>, K> {
    ...
    @Operation(operationId = "findById",
            ...
            parameters = {
                    @Parameter(description = "The primary key id of the entity to be retrieved.",
                            name = "id",
                            required = true)
            },
            responses = {@ApiResponse(responseCode = "200",
    ...
    @Operation(operationId = "create",
            ...
            requestBody =
            @RequestBody(description = "The DTO used to create the entity.",
                    required = true),
            responses = {@ApiResponse(responseCode = "200",
    ...
    @Operation(operationId = "createAll",
            summary = "Creates entities.",
            description = "Use this API to create a new entity.",
            requestBody =
            @RequestBody(description = "A list of  DTOs used to create the entities.",
                    required = true),
            responses = {@ApiResponse(responseCode = "200",
    ...
    @Operation(operationId = "update",
            ...
            deprecated = true)
    ResponseEntity<D> update(@PathVariable(required = true) K id,
                             @RequestBody D dto);
    ...
    @Operation(operationId = "deleteAllById",
            ...
            requestBody =
            @RequestBody(description = "The ids used to delete the entities by.",
                    required = true),
            responses = {@ApiResponse(responseCode = "204",
                    description = "The entity was deleted by its id successfully. A redirect is" +
                            " not required.")})
