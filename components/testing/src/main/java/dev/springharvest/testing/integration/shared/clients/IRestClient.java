...
public interface IRestClient {
    ...
    /**
     * Given a URI, a map of query parameters, and a list of path parameters, perform a GET request and return the
     * response.
     *
     * @param uri    The URI of the resource to be tested.
    ...
    /**
     * Given a URI, a body, a map of query parameters, and a list of path parameters, perform a POST request and return
     * the response.
     *
     * @param uri    The URI of the resource to be tested.
     * @param body   The body of the request.
