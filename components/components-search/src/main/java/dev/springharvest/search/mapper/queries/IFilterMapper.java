 ...
 */
public interface IFilterMapper<RD extends BaseFilterRequestDTO, RB extends BaseFilterRequestBO, D extends BaseFilterDTO, B extends BaseFilterBO> extends IParameterMapper {
    ...
    /**
     * This method is used to recursively iterate through all fields in the FilterParameter's class and its superclasses
     * to build the full path of the attributes contained within it.
     *
     * @param target The BaseFilterRequestBO object that will be mapped to.
     * @param source The BaseFilterRequestDTO object that will be mapped from.
