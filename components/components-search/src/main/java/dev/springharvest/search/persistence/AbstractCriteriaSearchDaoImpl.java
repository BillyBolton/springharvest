...
public abstract class AbstractCriteriaSearchDaoImpl<E extends BaseEntity<K>, K extends Serializable,
    ...
    /**
     * A helper method to aggregate a list of associated entities to the entity that owns this many-to-one
     * relationship.
     *
     * @param entities The list of entities that match the search request and need to aggregate the associated
     *                 entities.
     *
    ...
    private static class CriteriaBuilderHelper {
        ...
        /**
         * A utility debugging method that will recursively iterate the entity class and build a list of paths to each
         * attribute it has.
         *
        ...
        /**
         * A utility method that will build a map of the filter parameters in a search query, with the key as the
         * variable name that holds the FilterParameterBO, and the value as the FilterParameterBO. Java Reflection is
         * used to identify the key, so naming conventions is important.
         *
         * @param filterRequestBO The filter parameter business object that is contained in a Search Request and will be
         *                        used to build the map for this method.
         *
         ...
         * @param isJoined  The boolean flag that is used to identify whether the path is from a joined object with
         *                  respect to the Root object.
         *
         * @return
         *
         ...
         *
         * @param entry    The entry of the variable name that holds the FilterParameterBO object, and the value as the
         *                 actual FilterParameterBO object.
