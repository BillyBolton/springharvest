...
public interface IFilterParameter {
    ...
    /**
     * This method is used to get the alias of the filter parameter. This alias field is used to identify the
     * TupleElement that is returned from a TupleQuery.
     *
    ...
    /**
     * This method is used to set the alias of the filter parameter. This alias field is used to identify the
     * TupleElement that is returned from a TupleQuery.
     *
     * @see jakarta.persistence.Tuple
     * @see jakarta.persistence.TupleElement
