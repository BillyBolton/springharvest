...
public interface IParameterMapper {
    ...
    /**
     * This method identifies the class type based on the path that is passed. This method should be implemented in the
     * concrete Search mapper.
     *
     * @param path The path that will be used to identify the class type.
     *
     * @return The class type that is identified.
     *
     * @throws OperationNotSupportedException This exception is thrown when the method is not implemented in the
     *                                        concrete Search mapper.
     */
