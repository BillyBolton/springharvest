...
/**
 * This enum is used to represent the criteria operator. The criteria operator is used to determine the type of
 * comparison that will be performed on the field and value for a criteria search query.
 */
