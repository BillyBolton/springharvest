...
/**
 * This interface is used to represent the client exception. Client exceptions are acceptable to be sent to a consumer,
 * such as a front end client, to be displayed to the user.
 */
