...
public class ExceptionMessages {
  ...
  /**
   * Exception message for when a private constructor is called. Usually this message is needed in the constructor of utility classes that contain only static
   * methods.
   */
