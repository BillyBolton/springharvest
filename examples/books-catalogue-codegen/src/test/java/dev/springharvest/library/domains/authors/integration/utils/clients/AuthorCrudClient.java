...
import dev.springharvest.library.domains.authors.author.models.dtos.AuthorDTO;
import dev.springharvest.library.domains.authors.author.rest.constants.AuthorConstants_;
...
public class AuthorCrudClient extends AbstractCrudClientImpl<AuthorDTO, UUID> {
  ...
  protected AuthorCrudClient(RestClientImpl clientHelper) {
    super(clientHelper, new CrudUriFactory(AuthorConstants_.Controller.DOMAIN_CONTEXT), AuthorDTO.class);
  }
